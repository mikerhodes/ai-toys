...
with col1:
    user_prompt = st.text_area(
        "Image description",
        height=200,
        value="""Generate a high-fantasy cell-shaded avatar image of a female human mage. They have a time-worn face. They are wearing a richly detailed, dark travelling cloak with a simple golden clasp at the neck. Below the cloak, they are wearing well-worn trousers and scuffed, high travelling boots. They have richly coloured wisps of smoke-like magic surrounding them.""",
    )
